 ...
 * Config model
 */
class Mage_Postfinance_Model_Config extends Mage_Payment_Model_Config
{
    const POSTFINANCE_PAYMENT_PATH = 'payment/postfinance/';
    ...
    {
        return $this->getConfigData('postfinance_gateway', $storeId);
    }

    /**
     * Get PSPID, affiliation name in postfinance system
     *
     * @param int $storeId
     * @return string
     */
    ...
    {
        return Mage::getUrl('postfinance/api/paypage');
    }
    ...
    {
        return Mage::getUrl('postfinance/api/accept');
    }
    ...
    {
        return Mage::getUrl('postfinance/api/decline');
    }
    ...
    {
        return Mage::getUrl('postfinance/api/exception');
    }
    ...
    {
        return Mage::getUrl('postfinance/api/cancel');
    }

    /**
     * Return url which postfinance system will use as our magento home url on postfinance success page
     *
     * @return string
     */
