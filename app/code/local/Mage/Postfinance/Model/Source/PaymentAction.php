...
/**
 * Postfinance Payment Action Dropdown source
 */
class Mage_Postfinance_Model_Source_PaymentAction
{
    /**
    ...
    {
        return array(
            array('value' => '', 'label' => Mage::helper('postfinance')->__('Postfinance default Operation')),
